    ...
    <div class="right_content">
     ...
     <ul class="main_icons">
      ...
      <ul class="main_icons">
        ...
        </li>				    <li>            <a href="<?php echo $this->createUrl('/admin/department');?>" title="Business supermarket Department Emails">              <img  src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/department_emails.png" width="75px" height="75px" />            </a>        </li>
      </ul>     
      <div class="clearBoth"></div>
