...
?> 
    ...
    <form action="<?php echo Yii::app()->createUrl('user/login'); ?>" method="post" name="login_form" id="login_form" onsubmit="return login_validation(this.form)">
       ...
       <input onblur="if(this.value=='')this.value='Username'" onfocus="check_user_info(this.id);" type="text" name="drg_username" title="Username"  value="<?php if(isset($_COOKIE['dragonsnet']['username'])!=''){ echo $_COOKIE['dragonsnet']['username']; } else { echo "Username"; } ?>" id="drg_username" size="20"  />
                    	
        <div id="passwordbox">
            <input type="<?php echo ($_COOKIE['dragonsnet']['password']!='' ? "password" : "text"); ?>" id="drg_pass" name="drg_pass" value="<?php if(isset($_COOKIE['dragonsnet']['password'])!=''){ echo $_COOKIE['dragonsnet']['password']; } else { echo "Password"; } ?>" size="20" title="Enter your password" onfocus="check_pass_info(this.id);"  onblur="check_pass_out(this.id);" /> 
        </div>
        ...
        <div class="sign-option">
            <ul>
            	<li>
				<input type="checkbox" style="width:15px; float:right; margin-right:11px;" name="rememberme" id="rememberme" value="1" <?php if(isset($_COOKIE['dragonsnet'])!=''){ echo "checked='checked'"; } ?> /> 
                ...
                <li><span>Sign in to your account</span>
                    <span class="buttons-box">
                        <button class="login_sbmt" name="login_sbmt" type="submit" title='Log into your account'><img style="border-radius:5px;" src="images/buttons/user.png" width="25" /></button>
                     </span>
                </li>
            ...
            <li>
                <span>Submit</span>
                    ...
                    <button class="login_sbmt" name="lostpass_sbmt" type="button" onclick="return lost_password();">
                        <img style="border-radius:5px;" src="images/buttons/user.png" width="25"  />				 									  					</button>
                 </span>
             </li>
        </ul>
    </div> 
...
<div id="reset_success" style="display:none">      
    ...
    <div id="lostpass-box">
        ...
        <p style='text-align:right; padding-top:44px;'><a href="index.php">Close &#062;&#062 </a></p>
